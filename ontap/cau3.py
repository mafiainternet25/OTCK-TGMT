...
# h. khử nhiễu ảnh bằng bộ lọc song phương.
# i. thực hiện phân ngưỡng ảnh bằng thuật toán phân ngưỡng nhị phân.
...
bilateral = cv2.bilateralFilter(anhxam,15,15,15)

_,nhiphan = cv2.threshold(blur,1,255,0)
