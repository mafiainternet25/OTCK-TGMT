...
tilephong = float(input("tilephong= "))
anhtile = cv2.resize(anh, None, fx=tilephong, fy=tilephong)
cv2.imshow('anhtile', anhtile)

rongmoi = int(input("rong moi = "))
caomoi  = int(input("cao moi = "))
anhkichthuocmoi = cv2.resize(anh, (rongmoi, caomoi))
cv2.imshow('anhkichthuocmoi', anhkichthuocmoi)
